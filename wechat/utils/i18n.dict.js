...
module.exports = {
  ...
  "bindPhone": {
    ...
    "errOtpExpired": {
      "zh-Hans": "验证码已过期或未发送，请重新获取",
      "en": "Code expired or not sent, please request again"
    },
    "errOtpInvalid": {
      "zh-Hans": "验证码错误，请检查后重试",
      "en": "Invalid code, please check and retry"
    },
    "errAlreadyBound": {
      "zh-Hans": "该账号已绑定手机号",
      "en": "This account already has a phone bound"
    },
    "errRegisteredOther": {
      "zh-Hans": "该手机号已被其他账号注册",
      "en": "This phone is registered to another account"
    },
    "bindFailed": {
      "zh-Hans": "绑定失败，请稍后重试",
  ...
  "profileSetup": {
    ...
    "subtitle": {
      "zh-Hans": "设置昵称和头像，方便其他用户识别您",
      "en": "Set a nickname and avatar so others can recognize you"
    },
    "uploadAvatar": {
      "zh-Hans": "点击上传头像",
      "en": "Tap to upload avatar"
    },
    "nickname": {
      "zh-Hans": "昵称",
      "en": "Nickname"
  ...
  "emergencyContacts": {
    "hint": {
      "zh-Hans": "最多可设置 3 个紧急联系人，紧急情况下可一键呼叫",
      "en": "Up to 3 emergency contacts; call with one tap in emergencies"
    },
    "edit": {
      "zh-Hans": "编辑",
      "en": "Edit"
    ...
    "maxLimit": {
      "zh-Hans": "最多只能添加{count}个联系人",
      "en": "You can add at most {count} contacts",
      "_params": [
        "count"
      ]
    },
    ...
    "fillRelation": {
      "zh-Hans": "请填写关系",
      "en": "Please enter the relationship"
    },
    "updated": {
      "zh-Hans": "已更新",
      "en": "Updated"
    ...
    "deleteConfirm": {
      "zh-Hans": "确定要删除该紧急联系人吗？",
      "en": "Delete this emergency contact?"
    },
    "deleted": {
      "zh-Hans": "已删除",
      "en": "Deleted"
  ...
  "familyMembers": {
    "hint": {
      "zh-Hans": "添加家人后，下单时可指定为其本人就诊",
      "en": "After adding family members, you can order on their behalf"
    },
    "ageUnit": {
      "zh-Hans": "{age} 岁",
      "en": "{age} y/o",
    ...
    "notesPlaceholder": {
      "zh-Hans": "过敏史、慢性病等（选填）",
      "en": "Allergies, chronic conditions, etc. (optional)"
    },
    "loadFailed": {
      "zh-Hans": "加载失败",
      "en": "Failed to load"
    ...
    "invalidAge": {
      "zh-Hans": "年龄需为 0-130 的整数",
      "en": "Age must be an integer from 0 to 130"
    },
    "updated": {
      "zh-Hans": "已更新",
      "en": "Updated"
    ...
    "deleteConfirm": {
      "zh-Hans": "确定要删除该家人档案吗？历史订单不会受影响。",
      "en": "Delete this family member? Past orders are unaffected."
    },
    "deleted": {
      "zh-Hans": "已删除",
      "en": "Deleted"
  ...
  "profileEdit": {
    ...
    "certificationsPlaceholder": {
      ...
      "en": "Enter certifications, e.g. nurse license, health manager cert"
    },
    "bio": {
      "zh-Hans": "个人简介",
      "en": "Bio"
  ...
  "companionOrderDetail": {
    "subNewOrder": {
      "zh-Hans": "新订单，等待接单",
      "en": "New order, awaiting acceptance"
    },
    "subAccepted": {
      "zh-Hans": "已接单，准备开始服务",
      "en": "Accepted, preparing to start service"
    },
    "subInProgress": {
      "zh-Hans": "服务进行中",
    ...
    "notifiedWaiting": {
      "zh-Hans": "已通知患者，等待确认",
      "en": "Patient notified, awaiting confirmation"
    },
    "completeTitle": {
      "zh-Hans": "完成服务",
      "en": "Complete Service"
    ...
    "completeContent": {
      "zh-Hans": "确认已完成本次陪诊服务？",
      "en": "Confirm this companion service is complete?"
    },
    "completeConfirm": {
      "zh-Hans": "确认完成",
      "en": "Confirm Complete"
