...
describe('components/cert-card a11y labels', () => {
  ...
  test('wxml declares screen-reader labels for card, rows, status and hints', () => {
    ...
    expect(wxmlText).toContain('aria-label="{{ariaBadgeVerified}}"')
    expect(wxmlText).toContain('aria-label="{{ariaBadgePending}}"')
    expect(wxmlText).toContain('aria-label="{{ariaBadgeUnverified}}"')
    expect(wxmlText).toContain('aria-label="{{ariaName}}"')
    expect(wxmlText).toContain('aria-label="{{ariaWorkId}}"')
    expect(wxmlText).toContain('aria-label="{{ariaQualifications}}"')
    expect(wxmlText).toContain('aria-label="{{ariaVerifiedAt}}"')
  })
})
