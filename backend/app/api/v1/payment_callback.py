...
async def wechat_pay_callback(
    ...
    try:
        ...
        # 4) Apply business mutation. PaymentService handles the
        #    TD-PAY-01 defensive auto-refund branch internally when the
        #    linked order is already in a terminal state.
